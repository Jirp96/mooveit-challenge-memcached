...
describe('RetrievalResponse', function() {
  describe('#toString()', function() {
    it('respect RetrievalResponse string format - With Data', function() {
        ...
        let item1 = new Item([0, 1, 2], 'test_key', 1234, 1);
        item1.casUnique = 123;

        let item2 = new Item([3, 2, 1, 0], 'test_key_2', 1234, 2);
        item2.casUnique = 321;
        
        let resp = new RetrievalResponse(constants.RESPONSE_TYPES.RETRIEVAL_SUCCESS, [item1, item2]);
